-- removes foreign key constraint from department
ALTER TABLE IF EXISTS department
  DROP COLUMN manager;

  -- DROP the tables and departments
...
-- now the manager relationship between department and employee is possible
...
-- references both employee and project
